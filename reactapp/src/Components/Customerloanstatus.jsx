                ...
                <table id={loanData.approvalStatus==="approved"? "statusGrid1":"statusGrid2"}>
                  <tbody>
                    <tr>
                      ...
                      <td>{loanData.enterName}</td>
                      <td>Applicant Address:</td>
                      <td>{loanData.enterAddress}</td>
                      <td>Applicant Email:</td>
                      <td>{loanData.email}</td>
                    </tr>
                    <tr>
                      <td>Phone No:</td>
                      <td>{loanData.mobileNumber}</td>
                      <td>Aadhar Number:</td>
                      <td>{loanData.enterAadharNo}</td>
                      <td>Pan Number:</td>
                      <td>{loanData.enterPanNo}</td>
                    </tr>
                    <tr>
                      <td>Amount:</td>
                      <td>{loanData.enterAmount}</td>
                      <td>Loan ID:</td>
